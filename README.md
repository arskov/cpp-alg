...
1. [Greatest Common Divisor of Strings](src/gcd_of_strings.cpp)
1. [Happy Number (the repeated sum of the squares of its digits eventually converges to 1)](src/happy_number.cpp)
1. [Kth Largest Element in an Array](src/kth_largest_in_array.cpp)
1. [Reverse Words in a Sentence](src/reverse_words.cpp)
1. [Valid Palindrome](src/valid_palindrome_1.cpp)
